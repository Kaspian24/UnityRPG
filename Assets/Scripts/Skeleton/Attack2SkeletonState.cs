...
/// <summary>
/// The Attack2SkeletonState class represents the second attack state for a skeleton character in a state machine.
/// This class handles the behavior of the skeleton during this attack state, including activating and deactivating the sword's collider for hit detection.
/// </summary>
public class Attack2SkeletonState : StateMachineBehaviour
{
    float timer;
    Transform player;
    GameObject sword;
